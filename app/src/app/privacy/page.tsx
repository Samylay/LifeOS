      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          <Section title="Overview">
            <p>
              Stride is a personal productivity application. Your data is stored in your own
          ...
          <Section title="Google Calendar Integration">
            <p>
              Stride offers an optional Google Calendar integration. When you connect your
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>
                <strong>No server-side storage:</strong> Stride does not transmit your
              ...
              <li>
                ...
                time from the Stride Settings page. You can also revoke access from your{" "}
                <a
          ...
          <Section title="Data We Collect">
            <p>
              Stride stores all user data in your own Firebase project. This includes:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <Section title="Data Sharing">
            <p>
              Stride does not sell, rent, or share your personal data with any third parties.
          ...
          <Section title="Cookies &amp; Local Storage">
            <p>
              Stride uses browser local storage and cookies only for authentication session
          ...
          <Section title="Contact">
            <p>
              ...
              <a
                href="https://github.com/Samylay/Stride"
                target="_blank"
                rel="noopener noreferrer"
                className="underline"
                style={{ color: "var(--accent)" }}
              >
                Stride GitHub repository
              </a>
              .
            </p>
          </Section>
